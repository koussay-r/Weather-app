  ...
  return (
    <div id="contact" className=' mt-20'>
        ...
        <div className='mt-20 lg:grid lg:ml-24 lg:grid-cols-2 '> 
            ...
            <p className={dark_Light?"text-white  text-center text-2xl font-bold":"text-black text-center text-2xl font-bold"}>Write me a project</p>
