  ...
  return (
    ...
    <div className='w-full h-[630px]'>
        ...
        <div className='flex justify-center'>
            ...
            <div className='group'>
            <button className='bg-white text-lg w-[300px] lg:w-[340px] py-4 lg:pl-5 pl-5  mx-auto mt-[30px] lg:mt-[60px] uppercase font-[400] lg:text-xl flex '>shop the fall collection <HiOutlineArrowNarrowRight className=' group-hover:ml-4 group-active:ml-4 transition-all duration-500 mt-[6px] ml-2 ' /> </button>
            </div>
            </div>
        </div>
