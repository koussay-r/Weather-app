...
export default function ProductsItems(props) {
  return (
    <div className='group  md:block md:mx-auto mr-2'>
        <div className='flex justify-center  w-full md:w-[400px] lg:w-[270px] relative'>
        <img src={props.image} alt="" className='lg:w-[270px] group-hover:brightness-90 transition-all duration-300   group-hover:cursor-pointer w-full md:w-[400px] h-[350px] object-cover'/>
        {
